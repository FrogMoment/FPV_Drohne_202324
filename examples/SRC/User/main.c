...
void TestMagn(void)
{
	...
	{
			MPU9250_Magn_Offset.X_Off_Err=(TestmagnBuff[0]+TestmagnBuff[3])/2;
			MPU9250_Magn_Offset.Y_Off_Err=(TestmagnBuff[1]+TestmagnBuff[4])/2;
			MPU9250_Magn_Offset.Z_Off_Err=(TestmagnBuff[5]+TestmagnBuff[8])/2;
